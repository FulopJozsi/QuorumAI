...
│               ┌─────────────────┼─────────────────┐         │
│          ┌────▼────┐      ┌─────▼────┐    ┌───────▼──────┐  │
│          │ Qdrant  │      │PostgreSQL│    │  FalkorDB    │  │ Асоціативна пам'ять іде далі: від згаданого спогаду вона проходить графом знань і виявляє пов'язані факти, про які ви не питали, — тож агент сам поєднує точки. Граф у GUI можна не лише переглядати, а й редагувати.
